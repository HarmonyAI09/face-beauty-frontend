      ...
      >
        <div style={{ width: "10%" }}>
          <Tooltip relationship="label" content={props.overview}>
            <MeasurementOverview source={props.source} title={props.measurement} overview={props.overview}></MeasurementOverview>
          </Tooltip>
        </div>
...
export const ViewReportDialog = () => {
  const measurement_overviews = [`This facial assessment is of high importance because the eyes are the first thing we tend to look at. The spacing of the eyes heavily influences how pleasant your eyes appear. 
